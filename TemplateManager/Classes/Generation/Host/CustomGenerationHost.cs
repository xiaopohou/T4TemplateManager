...
namespace Codenesium.TemplateGenerator.Classes.Generation
{
    ...
    //this code is from http://msdn.microsoft.com/en-us/library/bb126579%28v=vs.110%29.aspx
    //it's pretty barebones(especially assembly resolution) so I would like to improve it in the future.
    ...
    //-------------------------------------------------------------------------
    [Serializable]
    class CustomGenerationHost : ITextTemplatingEngineHost, ITextTemplatingSessionHost
    {
        ...
        public IList<string> StandardAssemblyReferences
        {
            get
            {
                return new string[]
                {
                    ...
                    typeof(System.Xml.XmlReader).Assembly.Location,
                    ...
                    typeof(GenerationLibrary.Generation.Parameter).Assembly.Location
        ...
        public bool LoadIncludeText(string requestFileName, out string content, out string location)
        {
            ...
            location = requestFileName;// You have to do this with VS 2013 SP3. http://stackoverflow.com/questions/25377848/t4-include-directive-broken-after-installing-vs2013-update-3
        ...
        public string ResolveAssemblyReference(string assemblyReference)
        {
            ...
            //Added by Travis to search for GAC dll's
            candidate = GACInterface.FindDllInGAC(assemblyReference);
            if (File.Exists(candidate))
            {
                return candidate;
            }
